...
let faveColors = ['red', 'green', 'purple']
...
let me = {
    firstName: 'Eric',
    superHeroName: 'Commander Glorious Warrior',
    homeTown: 'Phoenix',
    superPowers: ['Summoning Valhala', ' Odins Gaze', ' Its Not The Hot Tub Bubbles'],
    superPowerXP: () =>{
